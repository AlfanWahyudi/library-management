...
const AuthorViewDTO = {
  ...
  getAllPaginated: async ({
    ...
    const authorsPaginated = await AuthorViewDAL.getAllPaginated({page, limit, orderBy, orderDir, search, searchFields})
    authorsPaginated.data = mapResArrToDTO(authorsPaginated.data)
